<%-- 
    Document   : AtendimentoCliente
    Created on : 03/05/2022, 14:29:50
    Author     : Rafael Kulka
--%>
         ...
         <thead class="thead-dark">
            ...
            <tbody>
                <tr>
                    ...
                    <td><c:out value="${requestScope.atendimento.solucao}"/></td>
                    <td><a href="${pageContext.request.contextPath}/Atendimento?method=deletar&index=${atendimento.id}">deletar</a></td>
                </tr>

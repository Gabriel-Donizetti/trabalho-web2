...
<head>
    ...
    <title>Listagem de todos os atendimentos</title>
           ...
           <nav class="nav">
              <div>
                 ...
                 <div class="nav_list"> 
                      ...
                      <a href="ListagemAtendimentos.jsp" class="active nav_link"> 

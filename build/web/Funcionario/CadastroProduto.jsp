<%-- 
    ...
    Created on : 20/04/2022, 13:58:13
    Author     : Iury
--%>
   ...
   <div class="height-100 bg-light">
      ...
      <div id="cadastro">
         ...
         <div class="form-group">
            ...
            <input type="text" name="Nome" class="form-control" id="" value="Batom Vermelho">
            <label for="exampleFormControlSelect1">Categoria :</label>
            <input type="text" name="Categoria" id="" class="form-control" value="Batom">
            <label for="exampleFormControlSelect1">Descrição :</label>
            <input type="text" name="Descrição" id="" class="form-control" value="Descrição">
            <label for="exampleFormControlSelect1">Peso :</label>
            <input type="number" name="Peso" id="" class="form-control" value="20">              
            <br>

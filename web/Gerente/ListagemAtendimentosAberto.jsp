        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div>
                    ...
                    <div class="nav_list">
                        <a href="${pageContext.request.contextPath}/GerenteServlet?method=listar" class=" nav_link">
                        ...
                        <a href="${pageContext.request.contextPath}/Atendimento?method=listarAtendimentosAbertos" class="active nav_link">
                            <i class='bx bx-folder nav_icon'></i>

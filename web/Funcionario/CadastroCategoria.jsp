    ...
    <body id="body-pd">
        ...
        <div class="height-100 bg-light">
            ...
            <h4>Lista de Categorias</h4><table class="table">
                ...
                <tbody>
                <c:forEach items="${requestScope.categoria}" var="produto" varStatus="loop">
                    <tr>
                        <th scope="row">${loop.count}</th>
                        <td><c:out value="${categoria.nome}"/></td>
                    <td><c:out value="${categorias.nome}"/></td>
                    <td><a href="${pageContext.request.contextPath}/Categoria?method=#${categoria.nome}"></a>&nbsp;<a href="#" data-toggle="modal" data-target="#meuModal">Deletar</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>

            ...
            <div>
              ...
              <div class="nav_list"> 
                   ...
                   <a href="listagemAtendimentos.html" class="nav_link"> 
                       ...
                       <span class="nav_name"><img src="icon/atendimento.png" width="25" class="inverter" height="25" alt="Listagem de todos os atendimentos" title="Listagem de todos os atendimentos"></span> 
                   </a>
                   <a href="listagemAtendimentosAberto.html" class="nav_link"> 
                    <i class='bx bx-folder nav_icon'></i> 
                    <span class="active nav_name"><img src="icon/atendimentoAberto.png" width="25" class="inverter" height="25" alt="Listagem de todos os atendimentos" title="Listagem de todos os atendimentos"></span> 
                </a>   
               </div>
            </div>
